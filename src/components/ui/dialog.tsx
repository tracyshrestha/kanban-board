...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-lg leading-none font-semibold text-primary-foreground text-center", className)}
      {...props}
    />
  )
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-primary-foreground text-sm text-center ", className)}
      {...props}
    />
  )
}
